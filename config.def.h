...
static const Rule rules[] = {
    ...
    { "St",                   NULL,                 "ranger",                     0,            1,           0,           -1 },
    { "St",                   NULL,                 "newsboat",                   1 << 5,       1,           0,           -1 },
    { "St",                   NULL,                 "WeeChat",                    1 << 5,       1,           0,           -1 },
    { "Transmission-gtk",     NULL,                 NULL,                         1 << 4,       1,           0,           -1 },
    { "Postbird",             NULL,                 NULL,                         0,            1,           0,           -1 },
    { "xdman-Main",           NULL,                 "XDM 2020",                   0,            1,           0,           -1 },
    { "Guvcview",             NULL,                 NULL,                         1 << 4,       1,           0,           -1 },
    { "winword.exe",          NULL,                 NULL,                         0,            1,           0,           -1 },
    /* class                  instance              title                         tags mask     iscentered   isfloating   monitor */
    // Floating
    ...
    { "guvcview",             NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Key-mon",              NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Gnome-power-statistics", NULL,               NULL,                         0,            1,           1,           -1 },
    { "firefox",              "Browser",            "About Mozilla Firefox",      0,            1,           1,           -1 },
    { "Tor Browser",          "Browser",            "About Tor Browser",          0,            1,           1,           -1 },
    { "xdman-Main",           NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Gkamus",               NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Kazam",                NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Pysheng-gui",          NULL,                 NULL,                         0,            1,           1,           -1 },
    { "qtqr",                 NULL,                 NULL,                         0,            1,           1,           -1 },
    { "Mainwindow.py",        NULL,                 "PlayOnLinux",                0,            1,           1,           -1 },
    { "Florence",             NULL,                 NULL,                         0,            1,           1,           -1 },
    { NULL,                   NULL,                 "xzoom x2",                   0,            1,           1,           -1 },
    /* class                  instance              title                         tags mask     iscentered   isfloating   monitor */
    // Scratchpad
